    ...
    <div className="flex flex-col pt-16">
      ...
      <section className="mt-20 pb-12 space-y-10 md:space-y-15 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <h1 className="bg-gradient-to-r from-green-600 to-teal-500 font-extrabold tracking-tighter text-transparent bg-clip-text pb-1 pr-2 mx-auto max-w-6xl text-4xl md:text-8xl">
